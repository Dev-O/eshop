...
import com.eshop.core.product.hateoas.GroupResource;
...
public class GroupController {
    ...
    public List<GroupResource> index() {
        List<ProductGroup> list = productService.getGroups();
    ...
    public GroupResource view(@PathVariable("id") long id){
        GroupResource gr = new GroupResource(productService.getGroup(id));
